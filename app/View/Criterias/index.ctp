            ...
            <table class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $criteria['Criteria']['id']), null, __('Deleting criterias will REMOVE association from KITCHENS or PRODUCTS.\nare you sure you want to do this?', $criteria['Criteria']['name'])); ?>
                    </td>
                </tr>
                <?php 
                }
