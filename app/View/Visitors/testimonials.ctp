...
$content_override = array('title' => 'SK Kitchens Gallery', 'css' => array('dropdown-checklist', 'visitors/testimonial'), 'js' => array('jquery-ui', 'dropdown-checklist','visitors/modal','visitors/filter'));
