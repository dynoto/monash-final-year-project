...
<?php echo $this->Form->create('CriteriaValuesProduct'); ?>
	<fieldset>
		<legend><?php echo __('Edit Criteria Values Product'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CriteriaValuesProduct.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('CriteriaValuesProduct.id'))); ?></li>
