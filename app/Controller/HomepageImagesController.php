...
class HomepageImagesController extends AppController {
	...
	public function index(){
        if($this->request->is('post')):
            ...
            if(isset($rqData['HomepageImage'])):
                ...
                $this->Session->setFlash('No items in the Homepage Management, please add image before update');
            endif;
        endif;
    ...
    public function add(){
        if($this->request->is('post')){
            $rqData = $this->request->data;
            if(isset($rqData['HomepageImage']['position'])):
            ...
            foreach ($rqData['HomepageImage']['position'] as $key => $value) {
                ...
                $this->Session->setFlash('No images selected?');
            endif;
